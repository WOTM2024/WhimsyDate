  ...
  return (
    ...
    >
      <SafeAreaView className="flex-1 items-center justify-center">
        <View className="m-4" />
        <View>
          <Text className="m-4 text-center text-6xl text-dark_text font-bold">
            Welcome
          </Text>
          <Text className="text-center text-6xl text-dark_text font-bold">
            {username}!
          </Text>
          <View className="p-4"/>
          <Text className="text-center text-2xl text-dark_text font-medium font-semibold">
        ...
        <View className="mt-16 flex-row items-center">
          <TouchableOpacity
            ...
            className="mt-8"
          >
            <ChevronLeftIcon size={50} color="#1e1e1e" />
          </TouchableOpacity>
              ...
              renderItem={({ index }) => {
                ...
                return (
                  <View className="flex-1">
                    ...
                    <TouchableOpacity
                      className="flex-1 justify-center items-center bg-slate-900 rounded-md border-2 border-transparent"
                      onPress={() =>
                    ...
                    >
                      ...
                      <Text style={{ paddingTop: 10, color: "#1e1e1e", fontSize: 30, fontWeight: "00", textAlign:"center", fontWeight: "500"}}>
          ...
          <TouchableOpacity
            ...
            className="mt-8"
          >
            <ChevronRightIcon size={50} color="#1e1e1e" />
          </TouchableOpacity>
        </View>
        <View>
